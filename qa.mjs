...
const index=read('index.html'), app=read('app.js'), projects=read('projetos/index.html'), about=read('sobre/index.html'), dataSource=read('data.js'), robots=read('robots.txt'), sitemap=read('sitemap.xml');
